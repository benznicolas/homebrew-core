class Promptfoo < Formula
  ...
  def install
    ...
    keep = node_modules.glob("@anthropic-ai/claude-agent-sdk/vendor/tree-sitter-bash/#{arch}-#{os}")
    rm_r(node_modules.glob("@anthropic-ai/claude-agent-sdk/vendor/tree-sitter-bash/*") - keep)
